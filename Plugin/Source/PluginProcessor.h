...
private:
    ...
    juce::AudioParameterFloat *pluck_position, *decay, *damping, *pickup_position, *tone, *width;
    juce::AudioParameterBool *bass, *harmonics;
    juce::AudioParameterChoice *material;
};
